...
// TEST:加入电源管理指令
static bool flightPowerStatus = true;
...
static void flight(void)
{
    ...
    if (flightPowerStatus == true) {
        ...
        {
            if (RCLock == false && isMFCanFly == true && MFLowPower == false && configParam.flight.flip == FLIP_ENABLE
...
/*RCLock属性*/
void setRCLock(bool set) { RCLock = set; }
bool getRCLock(void) { return RCLock; }

/*trimFlag属性*/
void setTrimFlag(bool set) { trimFlag = set; }
bool getTrimFlag(void) { return trimFlag; }

/*MFLowPower属性*/
void setMFLowPower(bool set) { MFLowPower = set; }
bool getMFLowPower(void) { return MFLowPower; }

/*isMFCanFly属性*/
void setIsMFCanFly(bool set) { isMFCanFly = set; }
bool getIsMFCanFly(void) { return isMFCanFly; }

void setFlightPowerStatus(bool set) { flightPowerStatus = set; }
bool getFlightPowerStatus(void) { return flightPowerStatus; }
